<template>
  <div>
    <div class="w-100 p-3 text-center" style="background-color: #24305e">
      ...
      <div class="b-row" style="height: 40px"></div>
      <div class="b-row">
        <div class="col"></div>
      ...
      <div class="b-row">
        <p class="text-white" style="font-size: 13px; margin-left: -175px;">
          <img
      ...
      <div class="b-row">
        <a href="https://www.instagram.com/">
          <img class="socialImg" width="30px" src="../assets/social/instagram.svg" />
        </a>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <a href="https://www.facebook.com/">
          <img class="socialImg" width="30px" src="../assets/social/facebook.svg" />
        </a>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <a href="https://github.com/Trabalho-Grupo-2/Projeto-EmoChamp">
          <img class="socialImg" width="30px" src="../assets/social/github.svg" />
        </a>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <a href="https://www.youtube.com/">
          <img class="socialImg" width="30px" src="../assets/social/youtube.svg" />
        </a>
      </div>
      <div class="b-row" style="height: 50px"></div>
      <div class="b-row">
        <p class="text-white" style="font-size: 12px">Copyright © 2021 EmoChamp</p>
      </div>
